...
public interface WordTrainingJoinDao {
    ...
    @Query("DELETE FROM words_trainings_joins WHERE wrd_tra_tra_id = :id")
    public void deleteWordTrainingJoinByTrainingId(Long id);

    @Query("DELETE FROM words_trainings_joins")
    public void deleteAllWordTrainingJoins();
}
