...
public class ViewMeaningsListAdapter extends ArrayAdapter<MeaningModel> {

    public ViewMeaningsListAdapter(Context context, ArrayList<MeaningModel> meaningModels) {
    ...
    public View getView(int position, View listItemView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(R.layout.view_meaning_model_adapter, parent, false);
        }
